...
- NE SUPPRIME PAS un contenu au motif qu'il est « générique ». Les conseils génériques EXACTS et utiles (guide d'achat, « comment choisir », entretien, conseils d'usage, FAQ) sont une VALEUR SEO/AIO attendue sur un article produit/service → garde-les et enrichis-les si besoin. Ne corrige/remplace QUE les données FAUSSES, OBSOLÈTES ou RÉELLEMENT hors-sujet. Une recommandation d'audit du type « séparer infos marque et conseils généraux » = RÉORGANISER/clarifier, JAMAIS supprimer les conseils.
