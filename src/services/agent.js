...
- **Section « Tableau comparatif prix / performance »** : NE PRODUIS PAS de tableau détaillé ni de données ligne par ligne (modèles, specs, prix…). Mentionne SEULEMENT, en 1-2 phrases, le TYPE de tableau qui enrichirait l'article et ce qu'il comparerait (ex. « un tableau comparant 3-4 modèles sur SCOP / puissance / prix / éligibilité CEE serait pertinent »). Le tableau lui-même (avec ses données) est construit dans la proposition de MAJ (vue APRÈS), pas dans l'audit.
- **Recommandations** : FUSIONNE « Actions prioritaires » et « Recommandations stratégiques » en UNE SEULE section consolidée (ce sont les mêmes recommandations, ça fait doublon). Garde un ordre de priorité (haute / moyenne) à l'intérieur de cette section unique ; ne crée pas deux sections séparées qui se répètent.
