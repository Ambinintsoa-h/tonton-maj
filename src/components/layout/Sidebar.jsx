...
const NAV_ALL = [
  ...
  { to: '/maj-en-attente', label: 'Mes MAJ',  icon: ListTodo, badge: true },
  { to: '/lots',           label: 'MAJ en lot',       icon: Layers,   roles: ['super_admin', 'manager', 'cq_ia'] },
  ...
  { to: '/suivi-positions', label: 'Suivi positions',  icon: TrendingUp, roles: ['super_admin'] },
